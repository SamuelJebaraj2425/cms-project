...
export default function HomePage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
            ...
            <div className="fixed bottom-17 left-8 flex gap-6">
                <Link
                    to="/About"
                    className="px-6 py-2 bg-gray-800 bg-opacity-80 text-white rounded hover:bg-blue-600 transition-colors duration-200 shadow"
                >
                    About
                </Link>
                <Link
                    to="/DeveloperPage"
                    className="px-6 py-2 bg-gray-800 bg-opacity-80 text-white rounded hover:bg-purple-600 transition-colors duration-200 shadow"
                >
                    Team
                </Link>
            </div>
